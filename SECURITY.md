...
Thank you for helping keep our SCSS to CSS Converter project secure! We appreciate contributions and reports from the community. This document provides guidelines for reporting security issues to ensure they are resolved responsibly and promptly.
...
2. **Send a private report**:
   ...
   - **Affected version(s)**: Specify the affected version(s) of the SCSS to CSS Converter.
...
To keep your usage of the SCSS to CSS Converter project secure:
